;; I had the following idea to setup the intitial market trend. However this must be done before the initial instrumental motivation is calculated.
;; This means that the setup of all the organisations, groups and individuals need to be revised
